...
<body>
  ...
  <script src="{{asset('backend/assets/modules/summernote/summernote-bs4.js')}}>
  </script{{asset('backend/assets/modules/chocolat/dist/js/jquery.chocolat.min.js')}}></script>
